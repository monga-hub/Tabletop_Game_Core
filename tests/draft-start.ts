...
const r = s.submit({ type: "pescaria.draft.start", agentId: "host", payload: { players: ["alice", "bob", "carol", "dave"] } });
...
const r2 = s.submit({ type: "pescaria.draft.start", agentId: "host", payload: { players: ["x","y"] } });
...
s2.submit({ type: "pescaria.draft.start", agentId: "host", payload: { players: ["alice", "bob", "carol", "dave"] } });
...
s3.submit({ type: "pescaria.draft.start", agentId: "host", payload: { players: ["alice", "bob", "carol", "dave"] } });
